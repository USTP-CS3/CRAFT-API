class Scheduler {
    ...
    static getSubjectFrequencyAtDates(subjectData, datesToCheck) {
        ...
        for (const subject of subjectData) {
            // Iterate over each schedule entry for the subject
            for (const scheduleEntry of subject.schedule) {
                ...
                if (datesToCheck.includes(weekday)) {
                    // Increment the frequency count for the subject
...
// Call the method to get subject frequency at certain dates
const result = scheduler.getSubjectFrequencyAtDates(['2023-01-01', '2023-01-15']);
console.log(result);
