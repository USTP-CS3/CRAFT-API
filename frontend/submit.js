...
form.addEventListener('submit', (e) => {
 ...
 // TODO: Add a check to see if the file is a PDF file

 // Loop through the files and append each to the FormData object
 // TODO: Passing the files directly to backend for faster processing rather than using for loop or another way other than for loop
